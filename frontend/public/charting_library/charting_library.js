var TradingView = (function (e) {
  ...
  ;((t = e.ActionId || (e.ActionId = {})).UnknownAction = 'UnknownAction'),
    ...
    ((R = e.ConnectionStatus || (e.ConnectionStatus = {}))[(R.Connected = 1)] =
      'Connected'),
    ...
    ((M = e.OrderStatus || (e.OrderStatus = {}))[(M.Canceled = 1)] =
      'Canceled'),
    (M[(M.Filled = 2)] = 'Filled'),
    ...
    ((B = e.OrderStatusFilter || (e.OrderStatusFilter = {}))[(B.All = 0)] =
      'All'),
    ...
    ((z = e.OrderTicketFocusControl || (e.OrderTicketFocusControl = {}))[
      (z.LimitPrice = 1)
    ] = 'LimitPrice'),
    ...
    (($ = e.NotificationType || (e.NotificationType = {}))[($.Error = 0)] =
      'Error'),
    ($[($.Success = 1)] = 'Success'),
    (function (e) {
    ...
    ((ie = e.StandardFormatterName || (e.StandardFormatterName = {})).Date =
      'date'),
    ...
    ((re = e.OverrideLineStyle || (e.OverrideLineStyle = {}))[(re.Solid = 0)] =
      'Solid'),
    ...
    (se[(se.SVP = 20)] = 'SVP'),
    ((le = e.TimeHoursFormat || (e.TimeHoursFormat = {})).TwentyFourHours =
      '24-hours'),
    ...
    ((he =
      ...
      (e.TradedGroupHorizontalAlignment = {}))[(he.Left = 0)] = 'Left'),
    (he[(he.Center = 1)] = 'Center'),
    (he[(he.Right = 2)] = 'Right')
  e.PlDisplay.Money, e.PlDisplay.Money, e.TradedGroupHorizontalAlignment.Right
  var ge, ue, Ce, Se, pe, me, ye, _e, Te, be, Pe, Le, Ae, we, fe
  function ve(e, t) {
    const i = { ...e }
    for (const o in t)
  ...
  !(function (e) {
    ...
    ((me = e.PriceScaleMode || (e.PriceScaleMode = {}))[(me.Normal = 0)] =
      'Normal'),
    (me[(me.Log = 1)] = 'Log'),
    ...
    ((Te = e.HHistDirection || (e.HHistDirection = {})).LeftToRight =
      'left_to_right'),
  ...
  const Ve = class {
    constructor(e) {
      ...
      'dark' ===
        (null !== (i = this._options.theme) && void 0 !== i
          ? i
          : 'light'
        ).toLowerCase() &&
        ...
        (this._options.debug || this._options.debug_broker) &&
          (Re ||
            ((Re = !0),
            console.log(
              'Using CL v28.5.0 (internal id fb6f897f @ 2024-12-18T12:27:11.562Z)'
            ))),
    ...
    async _create() {
      ...
      const r =
          null !==
            (t =
              null === (e = this._options.enabled_features) || void 0 === e
                ? void 0
                : e.includes('iframe_loading_same_origin')) &&
          void 0 !== t &&
          t,
        n =
          r ||
          (null !==
            (o =
              null === (i = this._options.enabled_features) || void 0 === i
                ? void 0
                : i.includes('iframe_loading_compatibility_mode')) &&
            void 0 !== o &&
            o),
        [a, s] = this._render(!n, r),
        l = this._options.container,
        d = 'string' == typeof l ? document.getElementById(l) : l
      if (null === d)
        throw new Error(
      ...
      r && (await this._innerWindowEvent('sameOriginLoad')),
        ...
        (this._options.autosize || this._options.fullscreen) &&
          ((c.style.width = '100%'),
          this._options.fullscreen || (c.style.height = '100%')),
    ...
    _render(e, t) {
      ...
      if (
        ...
        (o[this._id].chartContent = { json: this._options.saved_data }),
          this._options.saved_data_meta_info &&
            (o[this._id].chartContentExtendedData =
              this._options.saved_data_meta_info)
      ...
      const r = (function (e, t) {
        ...
        const o = new URL(`${e || ''}`, location.href).href,
          r = JSON.parse(
            '["bundles/runtime.0c59f90a8699f12ff40f.js","bundles/__LANG__.2312.a9353e46c20c3019a091.js","bundles/9662.03109f673cda5962c847.css","bundles/7346.a2efeed47130dd4e832c.js","bundles/library.8fdacc60e5256d6fcc84.js"]'
          ),
          n = encodeURIComponent(t),
          a =
            null !== (i = Oe.find(e => e.language === n)) && void 0 !== i
              ? i
              : { iso: 'en', dir: 'ltr' },
          s = `lang="${a.iso}" dir="${a.dir}"`,
          l = `\n${(function (e, t, i) {
            if (void 0 === e) return ''
            const o = [],
              r = []
            for (const n of e)
              n.endsWith('.js')
                ? o.push(
                    `<script defer crossorigin="anonymous" src="${n.replace(
                      '__LANG__',
                      i
                    )}"><\/script>`
                  )
                : n.endsWith('.css') &&
                  r.push(
                    `<link type="text/css" href="${
                      t ? n.replace(/\.css$/i, '.rtl.css') : n
                    }" rel="stylesheet"/>`
                  )
            return [...o, ...r].join('\n')
          })(r, 'rtl' === a.dir, n)}\n`
        return `<!DOCTYPE html><html ${
          (d = { bundles: l, localeLanguage: n, htmlAttrs: s, libraryPath: o })
            .htmlAttrs
        }><head><base href="${
          d.libraryPath
      ...
      if (e) {
        ...
        const e =
          null !== (i = this._options.library_path) && void 0 !== i ? i : '/'
      ...
      const a =
        ...
        (this._options.time_scale
          ...
          : '')
      return [
        `<iframe\n\t\tversion="CL v28.5.0 (internal id fb6f897f @ 2024-12-18T12:27:11.562Z)" id="${
          this._id
        }" name="${this._id}" src="${n.href}" data-widget-options="${a}"\n\t\t${
          this._options.autosize || this._options.fullscreen
            ? ''
  ...
  return (e.version = De), (e.widget = Ve), e
})({})
